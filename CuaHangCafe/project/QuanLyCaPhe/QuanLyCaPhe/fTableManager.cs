...
namespace QuanLyCaPhe
{
    public partial class fTableManager : Form
    {
        ...
        void LoadCategory()
        {
            List<QuanLyCaPhe.DTO.Category> listCategory = CategoryDAO.Instance.GetListCategory();
        ...
        {
            lsvBill.Items.Clear();
            List<QuanLyCaPhe.DTO.Menu> listBillInfo = MenuDAO.Instance.GetlistMenuByTable(id);
            float totalPrice = 0;
